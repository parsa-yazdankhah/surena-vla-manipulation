...
TASK_SPECS: Dict[str, Dict[str, Any]] = {
    ...
    "SurenaPutKetchupInTopDrawer": {
        ...
        "runner_overrides": {
            ...
            "sticky_attach_distance": 0.070,
            "grasp_close_pose_tolerance": 0.015,
            ...
            "grasp_transport_clearance": 0.120,
            ...
            "grasp_blend_alpha_hover": 0.50,
            "grasp_blend_alpha_approach": 0.60,
            "grasp_blend_alpha_transport": 0.65,
            "grasp_blend_alpha_lower": 0.65,
            "grasp_blend_alpha_close": 0.20,
            "grasp_position_guidance_gain": 7.0,
            "grasp_max_position_correction": 0.02,
        },
    },
    ...
    "SurenaPutBlackBowlOnPlate": {
        ...
        "runner_overrides": {
            ...
            "grasp_blend_alpha_transport": 0.50,
            "grasp_blend_alpha_lower": 0.50,
            "grasp_blend_alpha_close": 0.15,
            "grasp_position_guidance_gain": 6.0,
            "grasp_max_position_correction": 0.03,
        },
    },
    ...
    "SurenaCloseMicrowave": {
        ...
        "contact_guidance": {
            ...
            "blend_alpha_follow": 0.65,
            "blend_alpha_recovery": 0.85,
            "blend_min_progress_fraction": 0.25,
        },
